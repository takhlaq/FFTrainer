...
namespace FFTrainer.Models
{
    public class CharacterDetails : BaseModel
    {
        ...
        public enum Emotes
        {
            ...
            [Description("Swimmiing Walk")] fdsqqaqd = 4950,
            [Description("Swimmiing Left")] fdqsqqaqd = 4951,
            [Description("Swimmiing Right")] fdqsqqqaqd = 4952,
            [Description("Swimmiing Backwards")] fdqs2qqqaqd = 4953,
            [Description("Swimmiing Forwards")] fdqs2qqqaaqd = 4954,
            [Description("Swimmiing Sprint Left")] fdqs2qqqaq3d = 4955,
            [Description("Swimmiing Sprint Right")] fdqs2qqwqaq3d = 4956,
            [Description("Swimmiing Sprint Start")] fdqs2eqqwqaq3d = 4957,
            [Description("Swimmiing Sprint Loop")] fdqs2eqqwqaqq3d = 4958,
            [Description("Swimmiing Sprint End")] fdqs2eqqwqqaqq3d = 4959,
            [Description("Swimmiing Fall End")] fdqs2eqqwqeqaqq3d = 4960,
